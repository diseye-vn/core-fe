            ...
            >
                ...
                <div className="overflow-y-auto overflow-x-hidden perfect-scrollbar h-full">
                    <div className="text-center relative pb-5">
                        ...
                        <h4 className="mb-1 dark:text-white">{t('theme_custom')}</h4>
                        <p className="text-white-dark">{t('theme_custom_description')}.</p>
                    </div>

                    <div className="border border-dashed border-white-light dark:border-[#1b2e4b] rounded-md mb-3 p-3">
                        <h5 className="mb-1 text-base dark:text-white leading-none">{t('dark_mode')}</h5>
                        <p className="text-white-dark text-xs">{t('dark_mode_description')}</p>
