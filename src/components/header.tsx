...
const HeaderImage: FC<HeaderImageProps> = ({ className }) => {
  return (
    <svg viewBox="0 0 375 96" fill="none" xmlns="http://www.w3.org/2000/svg">
