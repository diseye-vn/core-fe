                ...
                <div className="bg-white dark:bg-black h-full">
                    <div className="flex justify-between items-center px-4 py-3">
                        <NavLink to="/" className="main-logo flex items-center shrink-0">
                            <span className="text-2xl  font-semibold align-middle lg:inline dark:text-white-light">{t('name')}</span>
                            <img className="w-8 ml-[1px] flex-none" src="/assets/images/logo.svg" alt="logo" />
